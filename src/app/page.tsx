    ...
    */ <>
      ...
      */}
          <div className="align-middle text-typography-primary text-center col-start-4 col-end-6">
            ...
            <h6 className="bg-gray-950 text-typography-secondary-invert p-2">
              This is a H6 header
            </h6>
          </div>
          {/*
      ...
      */}
          <div className="col-start-2">
            ...
            <div className="font-BCSans text-typography-primary p-8 p-8 bg-blue-50">
              {" "}
              bg-blue-50{" "}
            </div>
            ...
            <div className="text-typography-primary font-bold p-8 p-8 bg-blue-200">
              {" "}
              bg-blue-200{" "}
            </div>
